...
const Details = (props) => {
    const [details, setDetails] = useState([
        ...
        {
            "id": 62,
            "title": "Amber Heard says she has received threats 'every single day' during trial: ",
